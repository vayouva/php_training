...
<form method="post" action="<?= $_SERVER['PHP_SELF']; ?>">
  ...
  <fieldset>
    <legend>Optional Extras
        ...
        <span class="warning">Plase select at least <?= $minimumChecked ?></span>
        <?php endif; ?>
    </legend>
    <input type="checkbox" name="extras[]" value="sun roof" id="extras_0"
        <?php if($_POST && in_array('sun roof', $extras)) {
            echo 'checked';
        }
        ?>
    >
    ...
    <input type="checkbox" name="extras[]" value="aircon" id="extras_1"
        <?php if($_POST && in_array('aircon', $extras)) {
            echo 'checked';
        }
        ?>
    >
    ...
    <input type="checkbox" name="extras[]" value="automatic" id="extras_2"
        <?php if($_POST && in_array('automatic', $extras)) {
            echo 'checked';
        }
        ?>
    >
