<?php 
$siteroot = '/introducingphp/ch07/07_06/begin';
set_include_path(get_include_path() . PATH_SEPARATOR . '/apache/htdocs/introducingphp/ch07/07_06/begin/includes');
?>
...
<div class="wrapper">
  ...
  <aside id="sidebar">
    <article>
      ...
      <div class="pixgrid">
        <ul>
          <?php require 'artistpix.php'; ?>
        </ul>
</div>
    </article>
    <!-- Featured Artists -->
    <?php require 'coming.php'; ?>
    <!-- Coming to event --> 
  </aside>
  <!-- Sidebar -->
